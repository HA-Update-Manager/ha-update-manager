...
from .const import (
    ...
    CONF_HIDE_NOT_INSTALLABLE_UPDATES,
    CONF_HIDE_POSTPONED,
    CONF_HIDE_SKIPPED_UPDATES,
        ...
        vol.Schema(
            {
                ...
                vol.Required(CONF_HIDE_SKIPPED_UPDATES): bool,
                vol.Required(CONF_HIDE_NOT_INSTALLABLE_UPDATES): bool,
